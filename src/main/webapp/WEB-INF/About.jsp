...
<header id="home">
    <div class="section__container">
        <h1 style="color:#ffcb0f; ">About Us</h1>
...
<section class="welcome-section">
    <div class="welcome-content">
        <h2>Construction Xpert Services</h2>
...
<section class="welcome-section">
    <div class="welcome-image">
        <img src="https://www.letsbuild.com/wp-content/uploads/2023/07/Depositphotos_89120612_s-2019.jpg" alt="Construction Worker">
    </div>
    <div class="welcome-content">
        <h2>Our History </h2>
        <p>Founded in 2020, Construction Company has quickly emerged as a leading force in the construction industry. Despite being a relatively young company, our dedication to innovation, integrity, and quality has propelled us to prominence. In a short span of time, we've undertaken a variety of projects, each contributing to our growing reputation for excellence. Our journey since inception reflects our unwavering commitment to building a better future for our clients and communities.</p>
        <a href="" style="display: inline-block;padding: 10px 20px;background-color: #ffcb0f ;color: #fff;text-decoration: none;border-radius: 5px;transition: background-color 0.3s ease;">Show More </a>
    </div>
</section>
<section class="welcome-section">
    <div class="welcome-content">
        <h2>Our team </h2>
        <p>At Construction Company, our team embodies passion and expertise in the construction industry. United by our commitment to excellence, we work in harmony to bring our clients' visions to life. With diverse skills ranging from project management to architectural design, we are determined to exceed expectations at every turn. Together, we form a strong team, ready to turn ideas into reality.
        </p>
        <a href="" style="display: inline-block;padding: 10px 20px;background-color: #ffcb0f ;color: #fff;text-decoration: none;border-radius: 5px;transition: background-color 0.3s ease;">Show More </a>
    </div>
    <div class="welcome-image">
        <img src="https://www.theconstructionindex.co.uk/assets/news_articles/2023/03/1678889209_15mar23-marcum.jpg" alt="Construction Worker">
    </div>
</section>
