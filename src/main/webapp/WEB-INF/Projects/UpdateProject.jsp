...
<section class="ADD"style="background-color: white ; width: 100% ;height: auto ; padding: 50px 20px;
    ...
    <h1 style="font-size: 36px;
            color: #ffc400;
            margin-bottom: 40px;">Update project</h1>
<form action="${pageContext.request.contextPath}/UpdateProjectServlet" method="POST">
    ...
    <input  style="margin-top: 30px" type="submit" value="Update Project"  onclick="return confirm('Are you sure you want to update this project?')" />
</form>
</section>
